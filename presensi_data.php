  ...
  <div class="col-md-12">
    <div class="content-panel">
      ...
      <table class="table table-striped table-advance table-hover">
       <h4><i class="fa fa-angle-right"></i> Presensi <?= $cari ?></h4>
       <hr>
       <thead>
        <tr>
          <th><i ></i>#</th>
          ...
          <?php if ($akses_user == 'admin') {
            echo '
            <th><a href="dashboard.php?tengah=presensi_tambah" class="btn btn-success btn-xs"><i class="fa fa-plus"></i></a></th> 
            ';
          }
          ?>
          <!-- kolom edit -->
      ...
      <tbody>
        ...
        while ($result = mysqli_fetch_object($query)) {
          ...
          <tr>
            ...
            <td><a href="dashboard.php?tengah=lembur_ubah&id=<?= $result->id_harian ?>"><?= $result->jam  ?></td>
            <td><a href="dashboard.php?tengah=tools_ubah&id=<?= $result->id_harian ?>"><?= $hasil1  ?></a></td>
            <td><a href="dashboard.php?tengah=masuk_ubah&id=<?= $result->id_harian ?>"><?= $result->masuk  ?></td>            
            <?php if ($akses_user == 'admin') {
            echo '
              <td>
