...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2019 at 04:51 AM
...
--
-- Dumping data for table `bobot_gaji`
--

INSERT INTO `bobot_gaji` (`id_bobot_gaji`, `dari`, `sampai`, `besaran_gaji`) VALUES
(1, 0, 25, 100000),
(2, 26, 50, 200000),
(3, 51, 75, 300000),
(4, 76, 100, 400000);
...
(1, 4, '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, 0, 0, 0),
(2, 5, '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, 0, 0, 0),
(3, 6, '0000-00-00', '0000-00-00', '0000-00-00', 0, 0, 0, 0, 0, 0, 0, 0),
(6, 5, '2019-12-02', '2019-12-07', '2019-12-07', 200000, 640000, 7, 0, 4, 140000, 240000, 60000),
(7, 5, '2019-12-02', '2019-12-07', '2019-12-09', 200000, 640000, 7, 0, 4, 140000, 240000, 60000),
(8, 5, '2019-12-02', '2019-12-07', '2019-12-10', 200000, 640000, 7, 0, 4, 140000, 240000, 60000);
...
(31, 5, '2019-12-02', 'ya'),
(32, 5, '2019-12-05', 'ya'),
(33, 5, '2019-12-06', 'tidak'),
(34, 5, '2019-12-07', 'tidak');
...
(4, 'Teknisi 1', 'teknisi_1', 'teknisi1123', 'teknisi', 'aaaaaa', '2019-12-01', 60000, 15000, 15000, '1'),
(5, 'Teknisi 2', 'teknisi_2', 'teknisi2123', 'teknisi', 'aaaaaa', '2019-12-01', 60000, 20000, 15000, '2'),
(6, 'Teknisi 3', 'teknisi_3', 'teknisi3123', 'teknisi', 'aaaaaa', '2019-12-01', 90000, 30000, 25000, '3');
...
(10, 5, '2019-12-02', 'Fery', 'Fery jauh dari sini', '0812334568', 'Ferza', 'Ferbagai hal sudah ada', 'Puas'),
(11, 5, '2019-12-05', 'Haert', 'Hunian dekat sini', '081231241', 'Hando', 'Habis bensin', 'Sangat Puas'),
(12, 5, '2019-12-06', 'Ipon', 'Ini sedang ditulis', '0812124141', 'Itger', 'Ini dan itunya rusak', 'Puas'),
(13, 5, '2019-12-07', 'Jane', 'Jalan deket sana', '0812312412', 'Jujuquee', 'Jantungnya tidak berdetak', 'Sangat Puas');
...
--
ALTER TABLE `bobot_gaji`
  MODIFY `id_bobot_gaji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cek_tools`
--
ALTER TABLE `cek_tools`
  MODIFY `id_cek` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `presensi_harian`
  MODIFY `id_harian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `presensi_lembur`
--
ALTER TABLE `presensi_lembur`
  MODIFY `id_lembur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `tools`
--
ALTER TABLE `tools`
  MODIFY `id_tools` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `workorder`
  MODIFY `id_workorder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
