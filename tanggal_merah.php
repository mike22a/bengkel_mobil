...
$query = mysqli_query($koneksi, "SELECT * FROM tanggal_merah limit $offset,$dataPerPage");

?>


<section class="wrapper">
 <h3><i class="fa fa-angle-right"></i> Data Tanggal Merah</h3>
      ...
      <table class="table table-striped table-advance table-hover">
       ...
       <thead>
        <tr>
          ...
          <th><a href="dashboard.php?tengah=tanggal_merah_tambah" class="btn btn-success btn-xs"><i class="fa fa-plus"></i></a></th> <!-- kolom edit -->
        </tr>
      </thead>
      <tbody>
        <?php $i=$offset+1;
...
<?php
  $qcount = "SELECT count(*) AS jumData FROM tanggal_merah ;
  ...
  if ($noPage > 1)
    echo " <li>
                <a href='" .$_SERVER['PHP_SELF'] . "&tengah=tanggal_merah&page=" . ($noPage - 1) .  "'>&lt;&lt; Prev</a></li>"
                ;
  ...
  for ($page = 1; $page <= $jumPage; $page++) {
    if ((($page >= $noPage - 3) && ($page <= $noPage + 3)) || ($page == 1) || ($page ==  $jumPage)) {
      ...
      if ($page == $noPage)
        ...
        echo "<li><a href = '" . $_SERVER['PHP_SELF'] . "&tengah=tanggal_merah&page=" . $page . "'>" . $page . "</a></li>";
      $showPage = $page;
    }
  }
  ...
  if ($noPage < $jumPage)
    echo "<li>
              <a href='" . $_SERVER['PHP_SELF'] . "&tengah=tanggal_merah&page=" . ($noPage + 1) . "'>Next &gt;&gt;</a></li>
    </ul>";
?>
